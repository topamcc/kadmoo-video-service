...
4. `docker compose up --build` (API + worker + Redis). Redis is internal-only; expose **4100** for the API on your host / RunPod HTTP service.
...
**RunPod / production checklist:** [DEPLOY-RUNPOD.md](./DEPLOY-RUNPOD.md)
